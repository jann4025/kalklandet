...
function start() {
    ...
    async function getJsonIntro() {
        let url = "https://janhol.dk/kea/07-cms/kalklandet/backend/wp-json/wp/v2/stevns_klint";
        let jsonData = await fetch(url);
